            ...
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button className="flex-1 bg-blue-700 text-white py-2.5 rounded-lg font-medium hover:bg-blue-500 flex items-center justify-center gap-2 transition-colors">
